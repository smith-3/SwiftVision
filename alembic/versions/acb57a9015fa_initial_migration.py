...
Revision ID: acb57a9015fa
Revises: 
Create Date: 2024-10-02 09:03:12.749839
...
def upgrade() -> None:
    ...
    sa.Column('segmentation', sa.Text(), nullable=False),
    sa.Column('bbox', sa.String(length=255), nullable=True),
    sa.Column('crop_box', sa.String(length=255), nullable=True),
