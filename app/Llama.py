...
class LamaInpaint:
    def __init__(self, lama_config: str, lama_ckpt: str, output_dir: str, device="cuda"):
...
if __name__ == "__main__":
    ...
    lama.process_images(input_img_path="FA_demo/FA1_dog.png", mask_glob="results/FA1_dog/mask*.png")
